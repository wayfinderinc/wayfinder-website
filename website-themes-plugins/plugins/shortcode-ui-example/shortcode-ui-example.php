 ...
 * Version: 1.0.0
 * Description: Adds [shortcake-dev] and [shortcake-no-attributes] example shortcodes to see Shortcode UI in action.
...
/**
 * Register two shortcodes, shortcake-dev and shortcake-no-attributes.
 *
...
function shortcode_ui_dev_register_shortcodes() {
	...
	add_shortcode( 'shortcake-dev', 'shortcode_ui_dev_shortcode' );
}
/*
...
/**
 * Shortcode UI setup for the shortcake-dev shortcode.
 *
 * It is called when the Shortcake action hook `register_shortcode_ui` is called.
 *
...
function shortcode_ui_dev_advanced_example() {
	...
	shortcode_ui_register_for_shortcode( 'shortcake-dev', $shortcode_ui_args );
}
/*
 * 3. Define the callback for the advanced shortcode.
 */
/**
 * Callback for the shortcake-dev shortcode.
 *
