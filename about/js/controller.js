...
var factsVideo = new ScrollMagic.Scene({triggerElement: "#factsVid"})
					.addTo(controller)
...
var factsArea = new ScrollMagic.Scene({triggerElement:"#factsBlock", triggerHook:".75"})
        .addTo(controller)
        //.addIndicators(true) // add indicators (requires plugin)
        .on("enter", function (e) {
          initStats();
...
var processAni = new ScrollMagic.Scene({triggerElement: "#cProcess"})
					.addTo(controller)
					//.addIndicators(true) // add indicators (requires plugin)
					.on("enter", function (e) {
...
if ( window.innerWidth >= 1280 ) {
  ...
  factsVideo.triggerHook(0.95);
  processAni.triggerHook(0.9);
